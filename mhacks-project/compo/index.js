...
//
//         <View style={styles.container}>
//         <Text> This is the first Location</Text>
//         //image
//       </View>
//
//
...
//
//         <View style={styles.container}>
//         <Text>This is the third Location</Text>
//         //image
//         </View>
//
//       </View>
...
export const BottomBar = ({ destination }) => (
  <View style={styles.bottomBar}>
    <View style={styles.tagLineContainer}>
      <Text style={styles.tagLine}>Explore our Planet Earth</Text>
    </View>
    <View style={styles.ports}>
      <View style={styles.port}>
        <Text style={styles.portTitle}>-></Text>
      </View>
      <View style={styles.port}>
